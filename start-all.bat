...
set "JAVA_HOME=C:\Intel\Oracle OpenJDK JDK 25.0.1\jdk-25.0.1"
set "JAVA=%JAVA_HOME%\bin\java.exe"
set "MVN=C:\Intel\Apache maven 3.9.11\apache-maven-3.9.11\bin\mvn.cmd"
set "ROOT=C:\Users\POOJAPENTELA\Desktop\sample\backend"
set "FRONTEND=C:\Users\POOJAPENTELA\Desktop\sample\frontend"
