resource "aws_ecr_repository" "eureka_server" {
  ...
  tags = { Name = "${var.project_name}-eureka-server-ecr" }
}
...
resource "aws_ecr_repository" "api_gateway" {
  ...
  tags = { Name = "${var.project_name}-api-gateway-ecr" }
}
...
resource "aws_ecr_repository" "ticket_service" {
  ...
  tags = { Name = "${var.project_name}-ticket-service-ecr" }
}
...
resource "aws_ecr_repository" "comment_service" {
  ...
  tags = { Name = "${var.project_name}-comment-service-ecr" }
}
...
resource "aws_ecr_repository" "attachment_service" {
  ...
  tags = { Name = "${var.project_name}-attachment-service-ecr" }
}
...
resource "aws_ecr_repository" "dashboard_service" {
  ...
  tags = { Name = "${var.project_name}-dashboard-service-ecr" }
}
